...
VALUES
    ('00000000-0000-0000-0003-000000000001', 'entity_schema.vehicle',         'entity_schema', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
    ('00000000-0000-0000-0003-000000000002', 'entity_schema.customer',        'entity_schema', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
    ('00000000-0000-0000-0003-000000000003', 'entity_schema.supplier',        'entity_schema', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
    ('00000000-0000-0000-0003-000000000004', 'entity_schema.parts',           'entity_schema', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
    ('00000000-0000-0000-0003-000000000005', 'entity_schema.employee',        'entity_schema', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
    ('00000000-0000-0000-0003-000000000006', 'entity_schema.technician',      'entity_schema', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
    ('00000000-0000-0000-0003-000000000007', 'entity_schema.finance_company', 'entity_schema', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
    ('00000000-0000-0000-0003-000000000008', 'entity_schema.part_category',   'entity_schema', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
...
INSERT INTO artifact_version
    (version_id, artifact_id, version_no, payload, is_active, is_draft, created_by, published_at, published_by)
VALUES
-- vehicle
(
