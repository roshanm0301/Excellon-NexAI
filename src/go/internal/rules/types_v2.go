...
const (
	...
	ClassificationPricing         RuleClassification = "Pricing"
	ClassificationChargeDiscount  RuleClassification = "ChargeDiscount"
	ClassificationTaxation        RuleClassification = "Taxation"
	ClassificationAccounting      RuleClassification = "Accounting"
	ClassificationBusinessProcess RuleClassification = "BusinessProcess"
)
...
const (
	...
	ContentTypeDecisionGraph ContentType = "decision_graph"
)
...
// GoRulesDecisionGraph stores the graph document used by @gorules/jdm-editor.
// Node and edge payloads stay open so editor metadata can round-trip.
type GoRulesDecisionGraph struct {
...
type RuleSetV2 struct {
	...
	// For decision_graph content type
	DecisionGraph *GoRulesDecisionGraph `json:"decision_graph,omitempty"`
}
