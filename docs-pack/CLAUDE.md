# CLAUDE.md â€” Excellon Enterprise Platform
...
The project uses the **Excellon Design System** accessible via Claude Design.
...
The design system is available to Claude Code at the start of each session via the project's Claude Design integration. Read it before writing any React component.
