...
import { CustomIconConfiguration } from './designer-configuration';

export interface CustomIconChangedEvent {
	type: string;
}
...
export class DesignerState {
	...
	public readonly onCustomIconChanged = new SimpleEvent<CustomIconChangedEvent>();
	public readonly onCustomIconsChanged = new SimpleEvent<CustomIconConfiguration>();
	...
	public setCustomIcon(type: string) {
		this.type = type;
	}
	...
	public notifyCustomIconChanged(type: string) {
		this.onCustomIconChanged.forward({ type });
	}
	...
	public setCustomIcons(customIcons: any) {
		if (this.customIcons !== customIcons) {
			this.customIcons = customIcons;
			this.onCustomIconsChanged.forward(customIcons);
		}
	}
