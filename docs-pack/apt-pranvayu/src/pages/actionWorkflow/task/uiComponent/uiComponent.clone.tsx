...
import { Payload } from "../../../../components/molecules/Payload";
...
export function UIComponentClone() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as UIComponentMethodType.Put, name: stepName || data.name || '' }));
    } else {
  ...
  return (
      ...
      <DXForm
        ...
        items={[
          ...
          {
            label: { text: "sourceDocumentId", location: "top" },
            dataField: "sourceDocumentId",
          },
          {
            itemType: "group",
            caption: "",
