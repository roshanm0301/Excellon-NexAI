...
import { SchemaMethodType } from "../../rule/task.schema";
...
export function PagingSchema() {
  ...
  const [formData, setFormData] = useState({
    id: "",
    name: "",
    method: SchemaMethodType.Paging,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as SchemaMethodType.Paging, name: stepName || data.name || '' }));
    } else {
    ...
    <>
        ...
        <DXForm
          ...
          items={[
            ...
            {
              label: { text: "Order By", location: "top" },
              dataField: "orderby",
            },
            {
