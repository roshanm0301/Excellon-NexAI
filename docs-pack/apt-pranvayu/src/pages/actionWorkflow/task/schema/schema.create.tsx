...
export function CreateSchema() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as SchemaMethodType.Post, name: stepName || data.name || '' }));
    } else {
