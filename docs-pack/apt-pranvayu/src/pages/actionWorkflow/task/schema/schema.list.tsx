...
import { ITaskSchemaList, SchemaMethodType } from "../../rule/task.schema";
...
export function ListSchema() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskSchemaList;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as SchemaMethodType.List, name: stepName || data.name || '' }));
    } else {
