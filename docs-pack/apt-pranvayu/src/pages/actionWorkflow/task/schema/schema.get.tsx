...
export function GetSchema() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskSchemaGet;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as SchemaMethodType.Get, name: stepName || data.name || '' }));
    } else {
