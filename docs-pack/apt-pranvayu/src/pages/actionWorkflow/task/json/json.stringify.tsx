...
import { ITaskJSONStringify, JsontMethodType } from "../../rule/task.json";
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            const data = properties?.taskSettings as ITaskJSONStringify;
            setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as JsontMethodType.Stringify, name: stepName || data.name || '' }));
        } else {
