...
import { ITaskJSONParse, JsontMethodType } from "../../rule/task.json";
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            const data = properties?.taskSettings as ITaskJSONParse;
            setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as JsontMethodType.Parse, name: stepName || data.name || '' }));
        } else {
                    ...
                    items={[
                        ...
                        },
                        {
                            ...
                            validationRules: [
                                {
                                    type: "required",
                                    message: isRequiredField("payload"),
                                },
                                // {
                                //     type: "pattern",
                                //     pattern: regEx.pattern,
                                //     message: isValidField("payload"),
                                // },
                            ],
                        },
                        {
