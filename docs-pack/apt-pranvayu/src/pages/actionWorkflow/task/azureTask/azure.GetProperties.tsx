...
export function GetProperties() {
  ...
  const [formData, setFormData] = useState({
    ...
    containerName:"",
    options: "",
    method: AzureMethodType.GetProperties,
    type: TaskType.Azure,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.GetProperties, name: stepName || data.name || '' }));
    } else {
