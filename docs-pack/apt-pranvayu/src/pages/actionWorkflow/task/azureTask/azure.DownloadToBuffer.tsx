...
export function DownloadToBuffer() {
  ...
  const [formData, setFormData] = useState({
    ...
    containerName:"",
    options: "",
    method: AzureMethodType.DownloadToBuffer,
    type: TaskType.Azure,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.DownloadToBuffer, name: stepName || data.name || '' }));
    } else {
