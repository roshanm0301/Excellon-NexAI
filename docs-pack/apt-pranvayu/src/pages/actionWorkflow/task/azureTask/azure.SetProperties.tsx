...
export function SetProperties() {
  ...
  const [formData, setFormData] = useState({
    ...
    containerName:"",
    options: "",
    method: AzureMethodType.SetProperties,
    properties:"",
    type: TaskType.Azure,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.SetProperties, name: stepName || data.name || '' }));
    } else {
    ...
    <div>
        ...
        <DXForm
          ...
          items={[
            ...
            {
              label: { text: "Properties", location: "top" },
