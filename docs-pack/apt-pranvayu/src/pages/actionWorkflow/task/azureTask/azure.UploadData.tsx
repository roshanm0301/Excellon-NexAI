...
export function UploadData() {
  ...
  const [formData, setFormData] = useState({
    ...
    containerName:"",
    options: "",
    method: AzureMethodType.UploadData,
    type: TaskType.Azure,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.UploadData, name: stepName || data.name || '' }));
    } else {
