...
export function UndeleteContainer() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.UndeleteContainer, name: stepName || data.name || '' }));
    } else {
    ...
    <div>
        ...
        <DXForm
          ...
          items={[
            ...
            {
              label: { text: "Deleted Container Name", location: "top" },
              dataField: "deletedContainerName",
              isRequired: true,
            },
            {
              label: { text: "Deleted Container Version", location: "top" },
              dataField: "deletedContainerVersion",
              isRequired: true,
            },
            {
              itemType: "group",
