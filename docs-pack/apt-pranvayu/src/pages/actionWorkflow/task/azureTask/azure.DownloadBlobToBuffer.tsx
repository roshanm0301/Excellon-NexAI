...
export function DownloadBlobToBuffer() {
  ...
  const [formData, setFormData] = useState({
    id: "",
    name: "",
    method: AzureMethodType.DownloadBlobToBuffer,
    blobName: "",
    offset: "",
    count: 0,
    containerName:"",
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.DownloadBlobToBuffer, name: stepName || data.name || '' }));
    } else {
    ...
    <div>
        ...
        <DXForm
          ...
          items={[
            ...
            {
              label: { text: "Blob Name", location: "top" },
              dataField: "blobName",
              isRequired: true,
            },
            {
              label: { text: "Offset", location: "top" },
              dataField: "offset",
              isRequired: true,
            },
            {
              label: { text: "Count", location: "top" },
              dataField: "count",
