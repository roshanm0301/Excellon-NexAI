...
export function CreateContainer() {
  ...
  const [formData, setFormData] = useState({
    id: "",
    name: "",
    method: AzureMethodType.CreateContainer,
    type: TaskType.Azure,
    containerName:"",
    options: "",
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.CreateContainer, name: stepName || data.name || '' }));
    } else {
