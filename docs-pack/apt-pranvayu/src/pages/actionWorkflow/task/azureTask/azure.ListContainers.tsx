...
export function ListContainers() {
  ...
  const [formData, setFormData] = useState({
    ...
    containerName:"",
    options: "",
    method: AzureMethodType.ListContainers,
    type: TaskType.Azure,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.ListContainers, name: stepName || data.name || '' }));
    } else {
