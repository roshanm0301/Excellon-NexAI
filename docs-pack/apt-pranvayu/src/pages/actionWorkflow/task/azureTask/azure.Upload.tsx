...
export function Upload() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.Upload, name: stepName || data.name || '' }));
    } else {
    ...
    <div>
        ...
        <DXForm
          ...
          items={[
            ...
            {
              label: { text: "Content Length", location: "top" },
