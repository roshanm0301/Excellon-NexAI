...
export function Download() {
  ...
  const [formData, setFormData] = useState({
    ...
    containerName:"",
    options: "",
    method: AzureMethodType.Download,
    type: TaskType.Azure,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as AzureMethodType.Download, name: stepName || data.name || '' }));
    } else {
