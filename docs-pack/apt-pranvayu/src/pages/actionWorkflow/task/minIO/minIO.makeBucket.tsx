...
import { ITaskMakeBucket } from "../../rule/task.minIO";
...
export function MakeBucket() {
  ...
  const [formData, setFormData] = useState({
    id: "",
    name: "",
    method: MiniIOMethodType.MakeBucket,
    bucketName: "",
    options: "",
    type: TaskType.MinIO,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskMakeBucket;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as MiniIOMethodType.MakeBucket, name: stepName || data.name || '' }));
    } else {
