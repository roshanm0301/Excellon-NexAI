...
export function GetObject() {
  ...
  const [formData, setFormData] = useState({
    ...
    method: MiniIOMethodType.GetObject,
    bucketName: "",
    objectName: "",
    options: "",
    type: TaskType.MinIO
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as MiniIOMethodType.GetObject, name: stepName || data.name || '' }));
    } else {
