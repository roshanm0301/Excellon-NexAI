...
export function StatObject() {
    ...
    const [formData, setFormData] = useState({
        ...
        method: MiniIOMethodType.StatObject,
        bucketName: "",
        objectName: "",
        options: "",
        type: TaskType.MinIO
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            ...
            setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as MiniIOMethodType.StatObject, name: stepName || data.name || '' }));
        } else {
