...
import { ITaskGetORM, ORMMethodType, TaskType } from "../../rule";
...
export function GetORM() {
  ...
  const [formData, setFormData] = useState({
    ...
    name: "",
    type: TaskType.ORM, // hardcoded readonly
    method: ORMMethodType.Get, // hardcoded readonly
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskGetORM;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as ORMMethodType.Get, name: stepName || data.name || '' }));
    } else {
