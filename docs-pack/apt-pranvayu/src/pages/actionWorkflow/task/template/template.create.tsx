...
export function TemplateCreate() {
  ...
  const [formData, setFormData] = useState({
    id: "",
    name: "",
    method: TemplateMethodType.Post,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as TemplateMethodType.Post, name: stepName || data.name || '' }));
    } else {
