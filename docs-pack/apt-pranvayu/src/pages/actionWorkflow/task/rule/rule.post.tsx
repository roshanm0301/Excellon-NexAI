...
import { ITaskRulePost, TaskType } from "../../rule";
import { MethodType } from "./rule.entity";

export const RulePost = React.memo(() => {
    ...
    const [formData, setFormData] = useState<ITaskRulePost>({
        id: "",
        name: "",
        type: TaskType.Rule,
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            const data = properties?.taskSettings as ITaskRulePost;
            setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as MethodType.Post, name: stepName || data.name || '' }));
        } else {
