...
import { ITaskRuleGet, TaskType } from "../../rule";
import { MethodType } from "./rule.entity";

export const RuleGet = React.memo(() => {
  ...
  const [formData, setFormData] = useState<ITaskRuleGet>({
    id: "",
    name: "",
    type: TaskType.Rule,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskRuleGet;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as MethodType.Get, name: stepName || data.name || '' }));
    } else {
