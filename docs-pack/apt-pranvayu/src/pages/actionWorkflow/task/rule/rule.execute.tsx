...
import { RulePayload } from "../../../../components/rulePayload/RulePayload";
...
import { ITaskRuleExecute, TaskType } from "../../rule";
import { MethodType } from "./rule.entity";
import { Payload } from "../../../../components/molecules";

export const RuleExecute = React.memo(() => {
  ...
  const [formData, setFormData] = useState<ITaskRuleExecute>({
    id: "",
    name: '',
    type: TaskType.Rule,
    method: MethodType.Execute,
    payload: [],
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as MethodType.Execute, name: stepName || data.name || '' }));
    } else {
