    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            ...
            if (data.paths) {
                ...
                setFormData(prev => ({ ...prev, ...data, path: obj, method: 'Encrypt', name: stepName || data.name || '' }))
            } else {
                setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: 'Encrypt', name: stepName || data.name || '' }));
            }
        } else {
