...
import { ITaskIdentifierUUID, IdentifierMethodType, TaskType } from "../../rule";

export function IdentifierUUID() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskIdentifierUUID;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as IdentifierMethodType.UUID, name: stepName || data.name || '' }));
    } else {
