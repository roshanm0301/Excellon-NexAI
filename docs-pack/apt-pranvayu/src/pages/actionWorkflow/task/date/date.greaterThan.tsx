...
import { DateMethodType, ITaskGreaterThan, TaskType } from "../../rule";
import { Format } from "./date.entity";
...
export function GreaterThanDate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskGreaterThan;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as DateMethodType.GreaterThan, name: stepName || data.name || '' }));
    } else {
    ...
    <>
        ...
        <DXForm
          ...
          items={[
            ...
            {
              label: { text: "Comparision Date", location: "top" },
              dataField: "comparisionDate",
              isRequired: true,
            },
            {
              itemType: "group",
