...
import { DateMethodType, ITaskLessThan, TaskType } from "../../rule";
...
export function LessThanDate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskLessThan;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as DateMethodType.LessThan, name: stepName || data.name || '' }));
    } else {
