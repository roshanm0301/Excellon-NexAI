...
import { DateMethodType, ITaskFormat, TaskType } from "../../rule";
...
export function FormatDate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskFormat;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as DateMethodType.Format, name: stepName || data.name || '' }));
    } else {
