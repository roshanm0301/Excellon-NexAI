...
import { DateMethodType, ITaskParse, TaskType } from "../../rule";
...
export function ParseDate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskParse;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as DateMethodType.Parse, name: stepName || data.name || '' }));
