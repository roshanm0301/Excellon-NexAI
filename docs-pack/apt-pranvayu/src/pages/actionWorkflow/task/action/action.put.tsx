...
export function ActionPut() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as ActionMethodType.Put, name: stepName || data.name || '' }));
    } else {
