...
export function ActionPost() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as ActionMethodType.Post, name: stepName || data.name || '' }));
    } else {
