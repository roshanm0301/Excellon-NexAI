...
import { ActionMethodType, ITaskGetAction } from "../../rule/task.action";
...
export function ActionGet() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskGetAction;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as ActionMethodType.Get, name: stepName || data.name || '' }));
    } else {
