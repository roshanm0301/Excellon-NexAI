...
import { IKeyValue } from "../../rule/common";
import { ITaskKeycloakClientCreate, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakClientCreate() {
    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            const data = properties?.taskSettings as ITaskKeycloakClientCreate;
            setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.ClientCreate, name: stepName || data.name || '' }));
        } else {
