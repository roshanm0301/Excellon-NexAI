...
import { ITaskKeycloakUserCreate, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakUserCreate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakUserCreate;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.UserCreate, name: stepName || data.name || '' }));
    } else {
