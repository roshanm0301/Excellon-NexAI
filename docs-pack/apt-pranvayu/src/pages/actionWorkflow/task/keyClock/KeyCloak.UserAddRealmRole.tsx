...
import { ITaskKeycloakUserAddRealmRole, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakUserAddRealmRole() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakUserAddRealmRole;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.UserAddRealmRole, name: stepName || data.name || '' }));
    } else {
