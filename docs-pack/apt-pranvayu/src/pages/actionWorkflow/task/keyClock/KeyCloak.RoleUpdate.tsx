...
import { ITaskKeycloakRoleUpdate, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakRoleUpdate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakRoleUpdate;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.RoleUpdate, name: stepName || data.name || '' }));
    } else {
