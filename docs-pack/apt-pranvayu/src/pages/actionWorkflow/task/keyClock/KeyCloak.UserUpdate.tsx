...
import { ITaskKeycloakUserUpdate, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakUserUpdate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakUserUpdate;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.UserUpdate, name: stepName || data.name || '' }));
    } else {
