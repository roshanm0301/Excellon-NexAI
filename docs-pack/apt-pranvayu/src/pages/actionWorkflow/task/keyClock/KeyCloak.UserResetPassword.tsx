...
import { ITaskKeycloakUserResetPassword, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakUserResetPassword() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakUserResetPassword;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.UserResetPassword, name: stepName || data.name || '' }));
    } else {
