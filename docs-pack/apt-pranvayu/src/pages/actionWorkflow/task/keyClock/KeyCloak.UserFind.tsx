...
import { ITaskKeycloakUserFind, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakUserFind() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakUserFind;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.UserFind, name: stepName || data.name || '' }));
    } else {
