...
import { ITaskKeycloakAuth, KeycloakMethodType } from "../../rule/task.keycloak";
...
export function KeyCloakAuth() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakAuth;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.Auth, name: stepName || data.name || '' }));
    } else {
