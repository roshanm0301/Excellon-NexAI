...
import { ITaskKeycloakClientUpdate, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakClientUpdate() {
    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            const data = properties?.taskSettings as ITaskKeycloakClientUpdate;
            setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.ClientUpdate, name: stepName || data.name || '' }));
        } else {
    ...
    return (
        <DXForm onFieldDataChanged={onFieldDataChanged}
            ...
            items={[
                ...
                {
                    label: { text: "kcClientId" },
                    dataField: "kcClientId",
                },
                {
                    itemType: "group",
                    caption: "",
