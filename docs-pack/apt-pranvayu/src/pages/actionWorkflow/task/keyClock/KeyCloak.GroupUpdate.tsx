...
import { ITaskKeycloakGroupUpdate, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakGroupUpdate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakGroupUpdate;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.GroupUpdate, name: stepName || data.name || '' }));
    } else {
