...
import { ITaskKeycloakUserListGroups, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakUserListGroups() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakUserListGroups;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.UserListGroups, name: stepName || data.name || '' }));
    } else {
