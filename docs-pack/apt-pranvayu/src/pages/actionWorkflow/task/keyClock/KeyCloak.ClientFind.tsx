...
import { ITaskKeycloakClientFind, KeycloakMethodType } from "../../rule/task.keycloak";
import { Payload } from "../../../../components/molecules";
import { createRoot } from "react-dom/client";

export function KeyCloakClientFind() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakClientFind;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.ClientFind, name: stepName || data.name || '' }));
    } else {
