...
import { ITaskKeycloakUserListRealmRoles, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakUserListRealmRoles() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakUserListRealmRoles;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.UserListRealmRoles, name: stepName || data.name || '' }));
    } else {
