...
import { ITaskKeycloakRoleCreate, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakRoleCreate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakRoleCreate;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.RoleCreate, name: stepName || data.name || '' }));
    } else {
