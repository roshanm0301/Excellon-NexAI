...
import { ITaskKeycloakGroupFind, KeycloakMethodType } from "../../rule/task.keycloak";
import { Payload } from "../../../../components/molecules";
import { createRoot } from "react-dom/client";

export function KeyCloakGroupFind() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakGroupFind;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.GroupFind, name: stepName || data.name || '' }));
    } else {
