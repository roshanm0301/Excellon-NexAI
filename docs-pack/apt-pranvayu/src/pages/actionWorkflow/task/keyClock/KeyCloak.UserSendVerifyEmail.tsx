...
import { ITaskKeycloakUserSendVerifyEmail, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakUserSendVerifyEmail() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakUserSendVerifyEmail;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.UserSendVerifyEmail, name: stepName || data.name || '' }));
    } else {
