...
import { ITaskKeycloakGroupCreate, KeycloakMethodType } from "../../rule/task.keycloak";

export function KeyCloakGroupCreate() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskKeycloakGroupCreate;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as KeycloakMethodType.GroupCreate, name: stepName || data.name || '' }));
    } else {
