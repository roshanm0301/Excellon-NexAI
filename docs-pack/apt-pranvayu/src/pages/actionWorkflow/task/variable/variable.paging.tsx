...
export function VariablePaging() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as VariableMethodType.Paging, name: stepName || data.name || '' }));
    } else {
