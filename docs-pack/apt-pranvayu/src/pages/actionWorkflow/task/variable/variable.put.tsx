...
import { VariableMethodType } from "../../rule/task.variable";

export function VariablePut() {
  let { id: stepId, name: stepName, setId, setName, properties, setProperty } =
    useStepEditor();
  const [formData, setFormData] = useState({
    id: "",
    name: "",
    method: VariableMethodType.Put,
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as VariableMethodType.Put, name: stepName || data.name || '' }));
    } else {
