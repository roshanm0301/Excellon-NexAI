...
import { ITaskRound, MathMethodType } from "../../rule/task.math";
...
export function MathRound() {
  ...
  const [formData, setFormData] = useState({
    ...
    method: 'Round', // hardcoded readonly
    name: '',
    expression: '',
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskRound;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as MathMethodType.Round, name: stepName || data.name || '' }));
    } else {
