...
import { ITaskGetSubscription, SubscriptionMethodType } from "../../rule/task.subscription";
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            const data = properties?.taskSettings as ITaskGetSubscription;
            setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as SubscriptionMethodType.Get, name: stepName || data.name || '' }));
        } else {
