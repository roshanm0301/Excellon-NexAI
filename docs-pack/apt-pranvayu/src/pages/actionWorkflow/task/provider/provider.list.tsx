...
import { ITaskProviderList, ProviderMethodType, TaskType } from "../../rule";
...
export function ListProvider() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskProviderList;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as ProviderMethodType.List, name: stepName || data.name || '' }));
    } else {
