...
import { ITaskProviderGet, ProviderMethodType, TaskType } from "../../rule";
...
export function GetProvider() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      const data = properties?.taskSettings as ITaskProviderGet;
      setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as ProviderMethodType.Get, name: stepName || data.name || '' }));
    } else {
  ...
  return (
    <>
        ...
        <DXForm onFieldDataChanged={onFieldDataChanged}
          formData={formData} stylingMode="outlined" items={[
          {
