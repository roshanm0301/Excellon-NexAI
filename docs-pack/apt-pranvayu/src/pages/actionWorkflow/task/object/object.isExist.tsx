...
import { ITaskIsExist, ObjectMethodType, TaskType } from "../../rule";
...
export function IsExist() {
	...
	const [formData, setFormData] = useState({
		...
		name: "",
		type: TaskType.Object, // hardcoded readonly
		method: "IsExist", // hardcoded readonly
		key: "",
		path: "",
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
	...
	useEffect(() => {
		if (properties?.taskSettings) {
			const data = properties?.taskSettings as ITaskIsExist;
			setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as ObjectMethodType.IsExist, name: stepName || data.name || '' }));
		} else {
