...
import { ITaskIsObject, ObjectMethodType, TaskType } from "../../rule";
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
	...
	useEffect(() => {
		if (properties?.taskSettings) {
			const data = properties?.taskSettings as ITaskIsObject;
			setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as ObjectMethodType.IsObject, name: stepName || data.name || '' }));
		} else {
