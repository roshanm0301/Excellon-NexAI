...
import { MethodType, TaskValidator } from "../../rule/task.validator";
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
    ...
    useEffect(() => {
        if (properties?.taskSettings) {
            const data: any = properties?.taskSettings as TaskValidator;
            setFormData(prev => ({ ...prev, ...data, id: stepId || data.id || prev.id, method: properties.type as MethodType.JSON, name: stepName || data.name || '' }));
        } else {
