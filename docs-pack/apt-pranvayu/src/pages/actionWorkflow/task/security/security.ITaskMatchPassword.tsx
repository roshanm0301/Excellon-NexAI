...
import { DXForm } from "../../../../components/atoms/useForm";
...
export function MatchPasswordSecurity() {
  ...
  useEffect(() => {
    if (properties?.taskSettings) {
      ...
      setFormData(prev => ({
        ...prev,
        ...data, id: stepId || data.id || prev.id, method: properties.type as MethodType.matchPassword,
