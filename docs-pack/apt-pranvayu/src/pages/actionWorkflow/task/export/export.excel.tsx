...
import { ExportMethodType, ITaskExport } from "../../rule/task.export";
...
export function EXCEL() {
  ...
  const { onFieldDataChanged, autoSave } = useAutoSave(formData, stepId, stepName, setProperty, setId, setName);
    ...
    useEffect(() => {
        handleGetSchema(getLocalData("params")?.SchemaId ?? "")
        if (properties?.taskSettings) {
            const data = properties?.taskSettings as ITaskExport;
            setFormData(prev => ({
                ...prev,
                ...data, id: stepId || data.id || prev.id, method: properties.type as ExportMethodType.EXCEL,
