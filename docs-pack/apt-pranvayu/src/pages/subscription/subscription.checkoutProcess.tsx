...
export const CheckoutProcess = (props: ICheckoutProcessProps) => {
  ...
  const onConfirmClick = () => {
    if (remark === "") {
      ...
      if (data) {
        // if (location.pathname.includes('/schema/edit-schema')) {
        //     checkout(IProvisioningRequestStatus.PendingForApproval, requestType.CheckoutRequest, EntityType.Action)
        // } else {
        checkout(
