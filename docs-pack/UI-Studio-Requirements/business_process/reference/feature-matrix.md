# Feature Matrix â€” UI Studio Business Requirements
...
## P0 â€” 20 Core Features (Must-Have)
...
| P0-05 | Field Picker from Entity Designer | Drag entity fields onto the canvas â€” no typing field names | P3 | M4 |
...
## P1 â€” 23 Enhanced Features (High Priority)
...
| P1-23 | Dynamic Tax / Charge Columns | Tax columns fetched from service â€” not hardcoded | P6 | M7 |
...
| P1-33 | Permission-Aware Rendering | Hidden fields absent from DOM â€” not just CSS hidden | P4 + P9 | M5 + M10 |
...
## P2 â€” 20 Productivity & AI Features
...
| P2-57 | AI View Generation | Describe a view in natural language â†’ draft created | P10 | M11 |
